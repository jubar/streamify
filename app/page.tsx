...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col px-2 md:px-10 py-8 pb-6 max-h-[calc(100vh-64px)] min-h-[calc(100vh-64px)] lg:min-h-screen lg:max-h-screen overflow-hidden relative">
